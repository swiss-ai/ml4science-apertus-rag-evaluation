...
|-------|----------------|------------------|---------------|--------------|-----------|
| Qwen/Qwen3-8B | 0.59/2.0 | 0.59/2.0 | 0.295/1.0 | 9 (9.0%) | 50 (50.0%) |
...
|-------|---------|---------|---------|---------------|
| Qwen/Qwen3-8B | 9 (9.0%) | 50 (50.0%) | 0 (0.0%) | 0 (0.0%) |
...
|-------|----------|----------------|------------------|---------------|
| Qwen/Qwen3-8B | DE | 0.41 | 0.41 | 0.206 |
| Qwen/Qwen3-8B | EN | 0.68 | 0.68 | 0.341 |
...
- **Qwen/Qwen3-8B**: 0.295 average aggregate score

### Most Honest (Highest Refusal Rate)
- **claude-sonnet-4.5**: 99.0% honest refusals (admits when it doesn't know)

### Least Hallucination
- **Qwen/Qwen3-8B**: 0.0% hallucination rate (invents false information)
